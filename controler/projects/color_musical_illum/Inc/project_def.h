...
#define ON_PB3()		GPIOB->BSRR = GPIO_BSRR_BS3
#define OFF_PB3()		GPIOB->BSRR = GPIO_BSRR_BR3

#define ON_PB5()		GPIOB->BSRR = GPIO_BSRR_BS5
#define OFF_PB5()		GPIOB->BSRR = GPIO_BSRR_BR5
